...
if __name__ == '__main__':
	...
	try:
		...
		vehicle_weights = '/content/data/vehicle-detector/yolo-voc.weights'
		vehicle_netcfg  = '/content/data/vehicle-detector/yolo-voc.cfg'
		vehicle_dataset = '/content/data/vehicle-detector/voc.data'
